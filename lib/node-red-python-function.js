...
class _Channel(object):
    """Wraps fd 3. On Windows, Node's IPC pipe frames every message with a 16-byte
    header (8-byte type, 8-byte little-endian length) before the JSON bytes; on
    POSIX it is plain newline-delimited JSON with no header. This makes both look
